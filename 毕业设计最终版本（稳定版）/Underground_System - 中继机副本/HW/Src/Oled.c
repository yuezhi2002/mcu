...
void LED_Init()
{
  ...
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
	...
	HAL_GPIO_WritePin(GPIOB, GPIO_PIN_0, GPIO_PIN_SET);//高电平灭
	HAL_GPIO_WritePin(GPIOB, GPIO_PIN_1, GPIO_PIN_SET);//高电平灭
	HAL_GPIO_WritePin(GPIOB, GPIO_PIN_10, GPIO_PIN_SET);//高电平灭
}
